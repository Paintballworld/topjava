...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2016, Month.DECEMBER, 15, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2016, Month.DECEMBER, 15, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2016, Month.DECEMBER, 15, 20, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2016, Month.DECEMBER, 14, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2016, Month.DECEMBER, 14, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2016, Month.DECEMBER, 14, 20, 0), "Ужин", 510)
    );
