...
<head>
    ...
    <script type="text/javascript" src="webjars/datetimepicker/2.5.4/build/jquery.datetimepicker.full.js" defer></script>
    <script type="text/javascript" src="webjars/momentjs/2.5.1/moment.js" defer></script>
