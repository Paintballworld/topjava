...
INSERT INTO meals (description, user_id, date_time, calories)
VALUES ('Ужин для админа', 100000, '2016-12-24 18:00:00', 500);
...
INSERT INTO meals (description, user_id, date_time, calories)
VALUES ('Завтрак - ямчница', 100001, '2016-12-25 06:00:00', 150);

INSERT INTO meals (description, user_id, date_time, calories)
VALUES ('Обед - Роллы', 100001, '2016-12-25 12:00:00', 800);

INSERT INTO meals (description, user_id, date_time, calories)
VALUES ('Ужин - Пюре с котлетой', 100001, '2016-12-25 19:10:00', 1250);
